...
# Source directory
source_dir="/home/jaber/TrueDetective/test"

# Base destination directory
base_destination="/home/jaber/TrueDetective/test/"
...
while [ "$(ls -A "$source_dir")" ]; do
    ...
    find "$source_dir" -maxdepth 1 -type f | head -n 3 | xargs -I {} mv {} "$destination_dir"
