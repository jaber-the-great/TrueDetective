...
def HeaderExtract(input_pcap, output_dir, numOfPackets):
    ...
    for pkt in flow:
        ...
        if counter == numOfPackets:
            ...
            if checkInternalIP(pkt['IP'].src):
                output_dir[-2] = pkt['IP'].src
            else:
                output_dir[-2] = pkt['IP'].dst
...
if __name__=="__main__":
    ...
    PacketsPerflow = 3
    inputFiles = "/mnt/md0/jaber/oneminSplit/"
    outputDirectory = "/mnt/md0/jaber/groupedcicflow"
    #HeaderExtract("/mnt/md0/jaber/oneminSplit/1/s2f0_00000_20221205201501-4438.pcap", "/mnt/md0/jaber/test.csv", 3)
    for i in range(1,112):
        print(i)
        directory = os.path.join(outputDirectory, str(i))
